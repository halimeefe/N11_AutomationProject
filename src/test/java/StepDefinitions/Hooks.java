...
public class Hooks {
    ...
    public void after(Scenario scenario) { // SENARYO HATALI AYNİ FAİL İSE PARANTEZİN İÇİNE TANIMLARIZ VE İF KOŞULU İLE EKRAN GÖRÜNTÜSÜ İSTEYEBİLİRİZ
        ...
        if (scenario.isFailed() || scenario.getStatus() == Status.PASSED) { // Senaryo fail yada pass olsa bile görüntü al
            ...
            try {
                FileUtils.copyFile(hafizadakiHali,
                        new File("target/ScreenShotsN11/" + scenario.getId() + "_" + date.format(formatter1) + ".png"));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    public String getN11ScreenShot() {
